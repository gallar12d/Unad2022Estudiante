...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Creación de actividad para docentes</h1>
                </div><!-- /.col -->


            </div><!-- /.row -->
            <form autocomplete="off"  autocomplete="off" enctype="multipart/form-data" method="post" action="{{route('activities_administrator.store')}}">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12 col-lg-12">
                                ...
                                <input value="{{ old('username') }}" required name="title" type="text" class="form-control" id="title" placeholder="Título">
                            </div>
                            <div class="form-group col-md-12 col-lg-12">
