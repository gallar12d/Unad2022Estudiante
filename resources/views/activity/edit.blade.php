...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edición de actividad para {{$level->name}}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6 ">
            ...
            <form autocomplete="off"  autocomplete="off" enctype="multipart/form-data" method="post" action="{{route('activities.update', $activity->id_activity)}}">
                @csrf
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <a onclick="return confirm('Está seguro que desea eliminar este registro?')" href="{{route('files.destroy', $file->id_file)}}" class="btn  btn-outline-danger">Eliminar</a>
                                            </td>
                                        </tr>
                                        @empty
                                        @endforelse
