...
<div class="content-wrapper solution">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Solucion actividad de <strong>{{Auth::user()->primer_nombre}} {{Auth::user()->primer_apellido}}</strong></h1>
                </div><!-- /.col -->
                <div class="col-sm-6 ">
                    <a role="button" href="{{route('activities_teacher.activitiesTeacher', $type)}}" class="btn btn-primary float-right">Actividades</a>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h5>Archivos adjuntos agregados por el coordinador</h5>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
            ...
            <div class="alert alert-success" role="alert">
                ...
                <hr>
                <h6 class="mb-0">Notas/observaciones de la solución/respuesta dejadas por el coordinador: <strong>{{$activity->coordinator->primer_nombre}} {{$activity->coordinator->primer_apellido}}</strong></h6>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form autocomplete="off"  autocomplete="off" enctype="multipart/form-data" method="post" action="{{route('activities.StoreSolutionStudent')}}">
                        ...
                        <br>
                        <hr>
                        <a class="btn btn-primary float-right" href="{{route('activities_teacher.activitiesTeacher', $type)}}">{{($activity->respuesta)? "Modificar solución": "Finalizar solución"}}</a>
                    </form>
                </div>
            </div>
            @else
            <div class="alert alert-danger" role="alert">
                No se puede dar solución a esta actividad porque el docente ha terminado el plazo de entrega.
            </div>
            @endif
