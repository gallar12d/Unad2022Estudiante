...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Creación de cead</h1>
                </div><!-- /.col -->


            </div><!-- /.row -->
            <form autocomplete="off" autocomplete="off" enctype="multipart/form-data" method="post" action="{{route('centros.store')}}">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-lg-6">
                                ...
                                <input required name="cead" type="text" class="form-control" id="centro" placeholder="Cead">
                            </div>
                            <div class="form-group col-md-6 col-lg-6">
                                <label for="nivel">Zona* </label>
                                <select name="id_zona" required class="form-control" id="nivel">
                                    @forelse($zonas as $n)
                                    <option value="{{$n->id_zona}}">{{$n->zona}}</option>
