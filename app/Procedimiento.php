...
class Procedimiento extends Model
{
    ...
    protected $fillable = ['nombre', 'anotacion', 'estado', 'fecha_inicio', 'id_usuario_responsable', 'id_programa', 'id_plantilla_procedimiento', 'programa', 'tipo', 'url_documento', 'ruta_raiz' ];
